...
v0.48: clients display completed LEFT `kind=message` as short
...
v0.51: waiting ··· until first token is client-only. Runtime
idle. OpenAPI stays 0.18.0.
...
v0.62: focus composer after Jump is client-only (Jump chip
or Esc=Jump returns composer focus; iOS hardware keyboard
