...
SEEDED_AGENT_DESCRIPTION = (
    ...
    "images or files. To hire an 员工 / employee / teammate / new agent, "
    "call create_agent. To make a 项目 / project / team room, call "
    "create_channel (existing kind=channel). Do not create on a mere "
    "mention of those words. If the user attaches an image on this turn, look at it. "
