...
Locked v0.1 / v0.2 / v0.3 / v0.4 / v0.5 / v0.6 / v0.7 / v0.8 / v0.9 / v0.10 / v0.11 / v0.12 / v0.13 / v0.14 / v0.15 / v0.16 / v0.17 / v0.18 / v0.19 / v0.20 / v0.21 / v0.22 / v0.23 / v0.24 / v0.25 / v0.26 / v0.27 / v0.28 / v0.29 / v0.30 / v0.31 / v0.32 / v0.33 / v0.34 / v0.35 / v0.36 / v0.37 / v0.38 / v0.39 / v0.40 / v0.41 / v0.42 / v0.43 / v0.44 / v0.45 / v0.46 / v0.47 / v0.48 / v0.49 / v0.50 / v0.51 / v0.52 / v0.53 / v0.54 / v0.55 (chat layout + agent messaging + collaboration handoff + identity pane + report-back + extra channels + basic tools + computer pane + runtime MCP client + question widgets + skills and cron routines + MCP connect chrome + assistant markdown + MCP Add custom + webhook event listeners + Box computer preview + Box takeover + teach-a-task + create/delete routine UI + skill markdown editor + iOS takeover + iOS Record + composer `/` skill autocomplete + blank New skill + Slack/GitHub inbound listeners + curated plugin catalog + chat attachments + agent-sent attachments + video attachments + watch-video tool + IME Enter + create agent/channel tools + composer clipboard paste + Copy / Regenerate + shell Approve + agent-created routines + user-right bubble wrap + collapse Computer pane + agent bootstrap + durable memory + memory pane + leftover Memory pane chrome + user-shared memory + Settings shared-memory list + desktop local voice dictation + leftover desktop mic chrome + iOS local voice dictation + local TTS Speak on LEFT messages + mermaid diagrams on LEFT `kind=message` + TeX math on LEFT `kind=message` + stick-to-bottom while streaming + short multi-bubbles on LEFT `kind=message` + optimistic user-RIGHT bubble on Send + Stop generating mid-stream + waiting ··· until first token + streaming caret on the growing LEFT bubble + Esc = Stop while generating + same-turn multi-bubble gap + Send muted while generating): [docs/specs/v0.1-chat-and-agents.md](docs/specs/v0.1-chat-and-agents.md).
