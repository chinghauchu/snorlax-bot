...
- Skills as durable how-to documents a bot can load. **v0.9 first slice:**
  ...
  per-agent durable facts (`MEMORY.md` next to that agent's skills);
  `remember` / `forget` always in the tool list; injected every turn.
