...
| Tauri + TypeScript chat UI; 320px computer pane (file tree + text preview, collapsible; v0.34 12px seam chevron, default collapsed, last choice persisted); agent-pane 288×180 computer preview + desktop Open/Done takeover + Record/Stop/Save as skill; v0.41 desktop composer mic (local whisper.cpp via `POST /v1/transcribe`; editable text; no auto-send) | Full sandbox computer GUI (browser, terminal, VNC); iOS mic / TTS |
