...
turn is streaming, offer Stop generating. Client abort of
the in-flight stream; keep the partial LEFT text. Composer
usable again; no auto-restart. OpenAPI stays 0.18.0.
...
- `SnorlaxBot/StopGenerating.swift` — v0.50 Stop generating (client abort)
