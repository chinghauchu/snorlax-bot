...
- Computer pane first slice is v0.6 (D2/B4): desktop file tree + preview over
  ...
  **v0.15:** desktop Open / Done takeover (pointer/key in 1280×800). **v0.16:**
  Record / Stop / Save as skill inside that overlay. iOS
